...
export function ReminderPanel() {
 ...
 async function openClock(kind: 'alarm'|'timer'|'list') {
 ...
 return <section className="card reminder-panel" aria-label="闹钟与锁屏提醒">
  ...
  <button type="button" className="soft-button" disabled={!supported || busy} onClick={() => void openClock('list')}>查看或管理系统闹钟</button>
