...
export const FocusKeepsake=memo(function FocusKeepsake({running}:{running:boolean}){
 ...
 return <div ref={ref} className="focus-keepsake" data-playing={running&&visible} aria-hidden="true"><div className="focus-keepsake-pendant"><span className="focus-keepsake-thread"/><img src="/images/companions/toast.webp" alt="" width="42" height="42" draggable={false}/><KeyRound size={15}/></div></div>;
});
